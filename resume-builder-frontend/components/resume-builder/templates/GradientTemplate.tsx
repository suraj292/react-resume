...
export function GradientTemplate({
    ...
    return (
        <>
            {/* Gradient Header */}
            <div className="mb-6 p-8 -mx-6 -mt-6 text-white rounded-b-3xl shadow-lg" style={gradientStyle}>
                <h1
                ...
                <p
                    className="text-xl font-light mb-4 opacity-95 outline-none hover:bg-white/10 px-2 -mx-2 rounded transition-colors cursor-text"
                    contentEditable
                    suppressContentEditableWarning
            ...
            {summary && (
                <div className="mb-6" style={{ pageBreakInside: 'avoid' }}>
                    ...
                    <p
                        className="text-xs text-slate-700 leading-relaxed pl-5 outline-none hover:bg-slate-50 px-2 -mx-2 rounded transition-colors cursor-text"
                        contentEditable
                        suppressContentEditableWarning
                    ...
                    <div style={{ pageBreakInside: 'avoid' }}>
                        ...
                        <div className="flex flex-wrap gap-2 pl-5">
                            {skills.map((skill, index) => (
                                <span
                                    key={index}
                                    className="px-3 py-1.5 text-xs font-semibold rounded-full text-white outline-none hover:shadow-lg transition-all cursor-text"
